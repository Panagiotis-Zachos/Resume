  ...
  \cventry
    ...
    {2023 -- Present} % Date(s)
    {
      \begin{cvitems} % Description(s) of project
        ...
        \item {\textbf{Technical Skills:} Proxmox, virtualization (VMs), Docker, Watchtower, NGINX reverse proxy, HTTPS/TLS, Home Assistant, media streaming, Linux administration.}
      \end{cvitems}
    }
