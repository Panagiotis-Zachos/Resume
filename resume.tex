...
\name{Panagiotis}{Zachos}
\position{Senior Audio \& Distributed Sensing Engineer{\enskip\cdotp\enskip}AI Researcher}
% \address{Lelas Karagianni 78, Athens, Greece
% }

\mobile{+306948226940}
\email{panzaxos@gmail.com}
%\dateofbirth{January 1st, 1970}
% \homepage{themagicalmammal.vercel.app}
\github{Panagiotis-Zachos}
\linkedin{panagiotis-zachos}
% \gitlab{gitlab-id}
...
% \medium{madium-id}
% \kaggle{kaggle-id}
\googlescholar{bUWYzDQAAAAJ&hl}{Scholar Profile}
